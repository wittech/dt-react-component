...
var EasySelect = /** @class */ (function (_super) {
    ...
    function EasySelect() {
        ...
        _this.state = __assign({}, initStates);
        _this.componentDidMount = function () {
            var _a = _this.props, _b = _a.autoValue, autoValue = _b === void 0 ? '' : _b, _c = _a.dataSource, dataSource = _c === void 0 ? [] : _c, _d = _a.auto, auto = _d === void 0 ? false : _d;
            if (dataSource.length > 0) {
                _this.lazyDataSource(dataSource);
            }
            else if (auto) {
        ...
        _this.lazyDataSource = function (data) {
            var _a = _this.state.scrollPage, scrollPage = _a === void 0 ? 1 : _a;
            var _b = _this.props.isLazy, isLazy = _b === void 0 ? true : _b;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!servise) return [3 /*break*/, 2];
                        return [4 /*yield*/, servise(str).then(function (res) {
                                _this.setState({
                                    str: str
                                }, function () {
                                    _this.lazyDataSource(res);
                                });
                            })];
                    case 1:
                        _a.sent();
        ...
        _this.companyScroll = function (e) {
            e.persist();
            var target = e.target;
            var _a = _this.state, str = _a.str, scrollPage = _a.scrollPage, allData = _a.allData;
            if (target.scrollTop + target.offsetHeight + 2 === target.scrollHeight && allData.length > 0) {
                var nextScrollPage = scrollPage + 1;
                _this.setState({ scrollPage: nextScrollPage }, function () { return _this.getDataSource(str); });
            }
        };
        return _this;
    }
    EasySelect.getDerivedStateFromProps = function (_a) {
    ...
    EasySelect.prototype.render = function () {
        ...
        return (React.createElement(Select, __assign({ allowClear: allowClear, showSearch: showSearch, style: { minWidth: 120 }, onSearch: servise && !filterLocal ? this.onSearch : null, filterOption: !filterLocal ? null : function (input, option) {
                // 兼容数字和字符串等模糊查询
                return option.props.children.toString().toLowerCase().indexOf(input.toLowerCase()) >= 0 ||
                    option.props.value.toString().toLowerCase().indexOf(input.toLowerCase()) >= 0;
            }, onPopupScroll: this.companyScroll }, others), dataSource &&
