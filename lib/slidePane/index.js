...
var SlidePane = /** @class */ (function (_super) {
    ...
    SlidePane.prototype.render = function () {
        ...
        var slidePrefixCls = 'dtc-slide-pane';
        var myStyle = {
            top: 0,
            transform: visible ? undefined : 'translate3d(150%, 0, 0)'
        };
        var classes = classNames(slidePrefixCls, className);
        if (!visible) {
        ...
        return (React.createElement("div", { className: classes, style: myStyle },
            React.createElement("div", { className: slidePrefixCls + "-conent", "data-testid": "slidepane_container", style: { display: visible ? 'block' : 'none', height: '100%' } }, children),
            React.createElement("span", __assign({ className: slidePrefixCls + "-toggle", "data-testid": "slidepane_action", onClick: onClose }, { onClick: onClose }),
