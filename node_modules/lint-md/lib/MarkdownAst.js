...
/*#__PURE__*/
function (_Ast) {
  _inherits(MarkdownAst, _Ast);

  function MarkdownAst() {
    _classCallCheck(this, MarkdownAst);

    return _possibleConstructorReturn(this, _getPrototypeOf(MarkdownAst).apply(this, arguments));
  }

  _createClass(MarkdownAst, [{
    key: "getSpec",
...
exports.MarkdownAst = MarkdownAst;