...
var _require3 = require('./helper/string'),
    substr = _require3.substr,
    startSpaceLen = _require3.startSpaceLen;
/**
        ...
        blockquote: function blockquote(ast) {
          ...
          if (_.startsWith(text, ' ')) {
            _this.cfg.throwError({
              ...
              text: "Blockquote content can not start with space: '".concat(substr(text), "'")
            });
          }
        }
      };
