...
describe('inject-decorator', () => {
  describe('positive', () => {
    ...
    const source = _fs.default.readFileSync(mockFilePath, 'utf-8');

    const result = (0, _injectDecorator.default)(source, ADD_DECORATOR_STATEMENT, _path.default.resolve(__dirname, mockFilePath), {
      parser: 'javascript'
    });
